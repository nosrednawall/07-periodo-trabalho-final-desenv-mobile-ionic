...
export class ApiService {
  ...
  private apiUrl:string = this.enderecoServidor+'/rest-1/rest/consultoria';

  constructor(private http: HttpClient, private storageB: Storage) { 
  ...
  getConsultorias (): Observable<Consultoria[]> {
    return this.http.get<Consultoria[]>(this.apiUrl)
      .pipe(
